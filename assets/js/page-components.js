...
var WizardBtn = Vue.component('WizardBtn',{
	...
	props: {
		...
		icon:{
            type: String,
            default: '<i class="material-icons">arrow_forward</i>'
        },
	},
	data: function() {
        return {
...
var Pagination = Vue.component('Pagination', {
	...
	props: {
		...
		firstText : {
			type : String,
			default : '<i class="material-icons">first_page</i>',
		},
		nextText : {
			type : String,
			default : '<i class="material-icons">arrow_forward</i>',
		...
		lastText : {
			type : String,
			default : '<i class="material-icons">last_page</i>',
		},
		prevText : {
			type : String,
			default : '<i class="material-icons">arrow_back</i>',
		},
