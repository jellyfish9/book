	...
	<body>
		<div id="page-actionbar">
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<button class="btn btn-danger btn-sm" onclick="printPage()"><img src="<?php print_link("assets/js/export-plugin/images/print.svg") ?>" /> 打印|PDF <img src="<?php print_link("assets/js/export-plugin/images/pdf.svg") ?>" /></button>
					<button   class="btn btn-warning  btn-sm" onclick="exportPng()"> 保存PNG <img src="<?php print_link("assets/js/export-plugin/images/png.svg") ?>" /> </button>
					<button  class="btn btn-success  btn-sm" onclick="exportCsv()"> 导出CSV <img src="<?php print_link("assets/js/export-plugin/images/csv.svg") ?>" /> </button>
					<button  class="btn btn-info  btn-sm" onclick="exportExcel()"> 导出Excel <img src="<?php print_link("assets/js/export-plugin/images/xls.svg") ?>" /> </button>
					<button  class="btn btn-primary  btn-sm" onclick="exportWord()"> 导出Word <img src="<?php print_link("assets/js/export-plugin/images/doc.svg") ?>" /> </button>
				</div>
			</div>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-2 d-print-none">	
					<div class="card my-4">
						<div class="card-header">打印页面设置</div>
						<div class="card-body">
							...
							<div class="form-group">
								<label class="btn btn-primary btn-block"><input onclick="toggleCompanyHeader()" checked="checked" type="checkbox" /> 显示标题</label>
							</div>
							<div class="form-group">
								<button onclick="removePageLinks()" class="btn btn-warning btn-block "> 删除页面链接</button>
							</div>
							
							<div class="page-title">导出页面字段</div>
