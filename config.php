<?php
	...
	define('APP_ID',"17f0f9f20f69019fb48595f3ab06cebe");
	...
	define("DEFAULT_LANGUAGE","chinese"); //Default Language
	
	
	
	// Page Meta Information
	define('META_AUTHOR','王伟');
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['uid'] : null ));
